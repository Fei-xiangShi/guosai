...
# 每年每种产品的销量统计
df2020_to_2021_S = df2020_to_2021.groupby(['分类编码', '分类名称']).agg({'销量(千克)': 'sum'}).reset_index()
df2021_to_2022_S = df2021_to_2022.groupby(['分类编码', '分类名称']).agg({'销量(千克)': 'sum'}).reset_index()
df2022_to_2023_S = df2022_to_2023.groupby(['分类编码', '分类名称']).agg({'销量(千克)': 'sum'}).reset_index()
